...
description: |
  Линза-методология «Калибровка доказательности 2026» (Evidence calibration synthesis 2026) совета adv-psy. Не терапия и не диагностика:
  одна методология, один способ прочтения ситуации, ходы с тирами SELF / REQUIRES-THERAPIST
  и citation-тегами [PG26:CODE]. Вызывается только советом adv-psy (workflow council-psy); вручную не запускается.
...
- **It measures surrogates.** PHQ-9, GAD-7 and their relatives stand in for behaviour change; hospitalization, attempt and relapse are almost never measured in the AI layer.
