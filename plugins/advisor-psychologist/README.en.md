...
| Worker | `agents/advisor-opus.md` | performs any council role; `model: claude-opus-5-5`, `effort: high`; in full mode the workflow raises the validator and the safety reviewer to `xhigh` |
