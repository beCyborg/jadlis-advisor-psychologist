...
description: |
  Линза-методология «Перфекционизм и непереносимость неопределённости» (Clinical perfectionism and intolerance of uncertainty) совета advisor-psychologist. Не терапия и не диагностика:
  одна методология, один способ прочтения ситуации, ходы с тирами SELF / REQUIRES-THERAPIST
  и citation-тегами [PERF:CODE]. Вызывается только советом advisor-psychologist (workflow council-psy); вручную не запускается.
